...
function getRandomFlavors(first, second, third, fourth) {
  let result = []

  const arrs = [first, second, third, fourth]
  for (let i = 0; i < 32; i++) {
    const arrIndex = Math.floor(Math.random() * arrs.length)
    const arr = arrs[arrIndex]
